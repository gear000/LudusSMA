...
export SQS_QUEUE_EVENTS_ARN="arn:aws:sqs:eu-west-1:730335476244:ScheduledEvents"
export SQS_QUEUE_TELEGRAM_UPDATES_NAME="TelegramUpdates"
export TELEGRAM_ALLOW_CHAT_IDS="/telegram/allow-chat-ids"
export TELEGRAM_BOT_KEY="/telegram/bot-token"